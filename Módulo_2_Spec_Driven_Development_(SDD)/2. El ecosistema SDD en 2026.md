# 📄 El ecosistema SDD en 2026 🔴 — 15 min
...
| Herramienta     | Origen                      | Lenguaje             | Filosofía                                          | Stars (abr 2026) |
| --------------- | --------------------------- | -------------------- | -------------------------------------------------- | ---------------- |
| OpenSpec        | Fission AI (open source)    | Node.js / TypeScript | Brownfield-first, ligero, multi-cliente            | ~43 k            |
| GitHub spec-kit | GitHub (open source)        | Python (uvx)         | Greenfield-first, lineal, gated                    | ~71 k            |
| BMAD-METHOD     | bmad-code-org (open source) | Multi-stack          | Sistema completo de agentes con roles, muy potente | n/a              |
| AWS Kiro        | Amazon (propietario)        | IDE propio           | Atado a Bedrock + Claude                           | n/a (closed)     |
| Tessl Specs     | Tessl (commercial)          | Plataforma SaaS      | Specs como producto, equipo enterprise             | n/a (commercial) |
...
* Facilidad de arranque — ¿el framework crea el contexto inicial por ti o tenés que escribirlo a mano?

* Buenas prácticas de manejo del contexto — ¿la estructura de ficheros que propone es coherente y escalable?

* Gestión de cambios — ¿soporta evolución de features y actualización de checklists, o solo el flujo inicial?

* Integración con IDEs — ¿se conecta nativamente con Claude Code, Cursor, Windsurf, etc., o exige glue code?

Aplicado a las 5 opciones de la tabla:

| Criterio                   |  OpenSpec |  spec-kit | BMAD |          Kiro | Tessl |
| -------------------------- | --------: | --------: | ---: | ------------: | ----: |
| Facilidad de arranque      |       ★★★ |        ★★ |    ★ |           ★★★ |   ★★★ |
| Manejo del contexto        |       ★★★ |        ★★ |  ★★★ |            ★★ |    ★★ |
| Gestión de cambios (delta) |       ★★★ |         ★ |   ★★ |             ★ |    ★★ |
| Integración con IDEs       | ★★★ (21+) | ★★★ (20+) |   ★★ | ★ (solo Kiro) |    ★★ |
...
| ---------------- | --------------------------- | --------------------------- |
| Orientación      | Brownfield (1→n)            | Greenfield (0→1) preferido  |
| Estructura       | Flexible, action-based      | Rígida, gated phases        |
| Granularidad     | Cambios pequeños frecuentes | Features completas          |
| Ceremonia        | Mínima                      | Constitution + 4 fases      |
| Stack            | Node                        | Python                      |
| Versión de specs | Delta specs (diffs)         | Specs completas por feature |
...
https://www.youtube.com/watch?v=a9eR1xsfvHg&t
...
| ------------------------------------------ | ---------------------------------------- |
| Specs largas describen el sistema completo | Specs cortas describen el cambio (delta) |
| La spec se escribe una vez                 | La spec evoluciona con cada feature      |
| El stack se elige al principio             | El stack ya está, hay que respetarlo     |
| El riesgo es la ambigüedad inicial         | El riesgo es romper algo que funciona    |
