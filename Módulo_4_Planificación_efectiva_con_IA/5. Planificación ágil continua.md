# 📄 Planificación ágil continua 🔴— 12 min
...
| Pre-IA                                          | AI-aware                                                                                               |
| ----------------------------------------------- | ------------------------------------------------------------------------------------------------------ |
| Ceremonia semanal de 1 hora con todo el equipo  | Refinamiento continuo (skill ejecutado al crear issue) + ceremonia más corta solo para casos complejos |
| El PO escribe el ticket completo                | El PO escribe la intención; un skill expande AC y formato                                              |
| Las stories llegan al refinamiento "vagas"      | Las stories llegan al refinamiento "demasiado completas" (riesgo: false completeness)                  |
| El cuello de botella es la escritura del ticket | El cuello de botella es la revisión y la conversación de equipo                                        |
