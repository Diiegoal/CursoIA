...
* ¿Tiene agentes nativos integrados? (no solo "AI summary", sino agentes que ejecutan trabajo)

* ¿Tiene MCP server oficial estable? (cómo lo enchufas a Claude Code/Cursor)

* ¿Está pensada para devs o para PMs/ops? (UX y modelo de datos)

Tabla rápida (datos verificados abril 2026):

| Herramienta       | Agente nativo                              | MCP oficial                | Audiencia                  | Pricing free tier                  |
| ----------------- | ------------------------------------------ | -------------------------- | -------------------------- | ---------------------------------- |
| Linear            | Linear Agent (beta, mar 2026)              | Sí (estable)               | Devs                       | Gratis hasta 250 issues / 10 users |
| Jira / Confluence | Rovo + Agents in Jira (open beta feb 2026) | Sí (Rovo MCP GA, feb 2026) | Empresa, mixto             | Free tier limitado, 10 users       |
| Notion            | Notion AI + agents                         | Sí (oficial)               | PMs / contenido / informal | Free, ilimitado para uso personal  |
| ClickUp           | ClickUp Brain                              | Comunidad                  | PMs, multi-función         | Free tier amplio                   |
| Asana             | Asana AI Studio + AI Teammates             | Comunidad                  | PMs no-tech                | Free hasta 10 users                |
| Monday.com        | Monday AI                                  | Comunidad                  | PMs no-tech                | Trial 14 días                      |
| GitHub Projects   | Copilot integration                        | Sí (vía gh CLI)            | Devs                       | Gratis con cuenta GH               |
| Trello            | Trello AI                                  | Limitado                   | Hobby / pequeño            | Free amplio                        |
| Height            | (cerrada sept 2025)                        | —                          | —                          | —                                  |
...
📺 https://www.youtube.com/watch?v=DF1vSmPYqzs

📌 Para los alumnos: cread cuenta gratuita en linear.app antes de la sesión en vivo. La invitación al workspace AI4Devs llegará vía email del programa.
...
* Usa MCPs oficiales cuando existen (Linear, Atlassian Rovo, GitHub).

* Lee el código de los MCPs comunidad antes de usarlos en algo serio.

* Mantén los MCPs en versión actual (los CVE se parchan; tu versión old no).

* Los hooks de seguridad de Claude Code (S3) pueden interceptar llamadas peligrosas — úsalos.
