# 📄 Documentación de API y código 🔴 — 16 min
...
| ------------------------------ | -------------------- | ------------------------------- | ------- |
| Dark mode nativo               | No                   | Sí                              | No      |
| Request client interactivo     | "Try it out" clásico | Integrado, limpio               | No      |
| Code generation                | No                   | curl, fetch, Go, Python, PHP... | No      |
| Bearer token persistente       | Manual               | Persistente en config           | —       |
| Performance con >100 endpoints | Lento                | Rápido                          | Rápido  |
| Self-hosting                   | Trivial              | Trivial                         | Trivial |
...
### Regla de proyecto recomendada en CLAUDE.md
...
El CLAUDE.md que tienes desde S1 es la capa de instrucciones del proyecto. La documentación TSDoc + TypeDoc es la capa de conocimiento del código. Las dos juntas hacen que el agente IA que trabaja en tu proyecto en el turno 50 de una sesión larga tenga el mismo nivel de comprensión que en el turno 1.
