# 📄 El déficit documental en la era IA 🔴 — 10 min
...
* Fuente de verdad en el repositorio: no existe en ningún sistema externo sin sincronización

* Actualización como parte del workflow: el PR que cambia código también actualiza la doc afectada

* Validación automatizada: si la doc se desactualiza, algo en CI se queja
...
| Tarea                                       | Sin IA                                                | Con IA                                                    |
| ------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------- |
| TSDoc para función existente                | 5 min/función, a menudo se omite                      | 30 seg + revisión                                         |
| Primer borrador de ADR                      | Requiere conocimiento de la plantilla + concentración | Prompt desde conversación o PR                            |
| Diagrama Mermaid del flujo de autenticación | 20-40 min                                             | Claude Code lee el código, genera el diagrama             |
| README actualizado tras refactor            | Nadie lo hace hasta que duele                         | Parte del PR, pedido por el hook                          |
| OpenAPI spec completa de un endpoint        | Requiere conocimiento de OpenAPI 3.x                  | Inferida desde el tipo de respuesta y el validator VineJS |
