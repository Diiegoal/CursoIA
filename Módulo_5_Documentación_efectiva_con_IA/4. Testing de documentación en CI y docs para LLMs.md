# 📄 Testing de documentación en CI y docs para LLMs 🔴 — 13 min
...
| Capa              | Herramienta       | Qué detecta                                                | Costo                      |
| ----------------- | ----------------- | ---------------------------------------------------------- | -------------------------- |
| Prosa             | Vale              | Errores de estilo, terminología, tono inconsistente        | Medio (config inicial)     |
| Sintaxis Markdown | markdownlint-cli2 | Markdown malformado, headers inconsistentes, listas rotas  | Bajo (reglas predefinidas) |
| Enlaces rotos     | lychee            | URLs muertas, anchors inexistentes, referencias circulares | Bajo                       |
| Cobertura TSDoc   | TypeDoc           | Funciones públicas sin documentar                          | Medio                      |
...
La convención (propuesta en 2024 por el equipo de FastHTML/Answer.AI, adoptada rápidamente por herramientas como Mintlify, Scalar, y Starlight):
