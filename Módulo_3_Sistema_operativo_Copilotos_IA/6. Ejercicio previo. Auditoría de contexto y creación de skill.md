# ✍️ Ejercicio previo: Auditoría de contexto y creación de skill 🔴

**Antonio Perez**

**Fecha de entrega:** 23 de Junio al final del día
...
- Saber si un copiloto entiende tu proyecto — y tener identificado qué le falta.
- Una skill creada en Claude Code a tu manera, sin guía formal de especificación.
...
- Los 3-5 hallazgos de la auditoría (Parte A, Paso 3): qué cosas no pudo inferir el agente de tu proyecto.
- El archivo `SKILL.md` de la skill creada (pega su contenido o enlázalo en tu repositorio sandbox).
- El diario de decisiones completo (Paso 7), incluyendo el resultado de la prueba (Paso 8).
...
Completa el ejercicio dentro de tu carpeta:

- Sube el documento único con los hallazgos de la Parte A, el `SKILL.md` y el diario de decisiones.
...
- "Create Your First Claude Code Skill" en egghead.io.
