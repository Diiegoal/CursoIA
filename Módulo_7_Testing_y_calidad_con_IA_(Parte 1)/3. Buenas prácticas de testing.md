...
| --------------------------- | ---------------------------------------- | -------------------------------------------------- |
| Tipos y estilo              | **TypeScript + ESLint + Prettier**       | La primera línea de defensa                        |
| Unit + integración backend  | **Vitest (o Jest) + Supertest**          | Tests rápidos de servicios y endpoints Express     |
| Integración con BD real     | **Testcontainers**                       | Postgres efímero en Docker por test suite          |
| Frontend                    | **Vitest + React Testing Library + MSW** | Componentes y llamadas mockeadas en la capa de red |
| E2E                         | **Playwright**                           | Flujos críticos en navegador real                  |
| Mutation testing (opcional) | **Stryker**                              | Calidad real de tus tests                          |
